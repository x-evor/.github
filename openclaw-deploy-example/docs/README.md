# OpenClaw Deploy Example / OpenClaw 部署示例仓库
...
- Root README: `openclaw-deploy-example`
- Previous docs index: `Documentation`
- Manifest evidence / 构建清单: repository structure and scripts only
- Active code and ops directories / 当前主要目录: `deploy/`, `scripts/`, `config/`

## Existing Docs To Reconcile / 需要继续归并的现有文档

- `ai-provider-token-security-architecture.md`
- `gcp-cloud-run.md`
- `juicefs-gcs-mount.md`
- `kong-provider-routing.md`
- `kong-routing.md`
- `macos-gcs-mount.md`
- `multi-gateway-architecture.md`
- `openclaw-gateway-runbook.md`
- `runbook-cloud-run.md`
- `storage-sync-scenarios.md`
